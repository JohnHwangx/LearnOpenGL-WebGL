...
export default function main() {
    ...
    async function render() {
        ...
        function drawScene(time: number) {
            ...
            camera.Pitch += 180.0; // rotate the camera's pitch 180 degrees around
            ...
            gl.clearColor(0.1, 0.1, 0.1, 1.0); // set clear color to white (not really necessary actually, since we won't be able to see behind the quad anyways)
            gl.clear(gl.COLOR_BUFFER_BIT | gl.DEPTH_BUFFER_BIT);
